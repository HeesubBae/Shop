...
public class ShopProductList_Handler  implements CommandHandler{
		...
		public String process(HttpServletRequest request,
			...
			ArrayList<DisplayBeans> datas = dd.SHOP_DISPLAY_SELECT_LIST(c3, c2, c1,search_txt,nowpage,pagesize);
