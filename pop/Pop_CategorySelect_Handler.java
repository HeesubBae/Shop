...
public class Pop_CategorySelect_Handler implements CommandHandler{
	@Override
	public String process(HttpServletRequest request,
		...
		request.setAttribute("product_cx_code_form", new product_cx_code().getProduct_cx_code_categoryselect(1,Integer.parseInt(c2),Integer.parseInt(c3)));
